...
class SequenceDB
{
	public:
		...
		void DRead( const char *file, const Options & options, std::vector<std::string> lines );
		void WriteClusters2( const char *db, const char *newdb, const Options & options, std::vector<std::string> lines );
