...
TEST(overlap, overlap_tss)
{
    ...
    EXPECT_TRUE(mapCompare(overlapRegions, controlRegions));
}

TEST(overlap, overlap_background)
{
    GenomicLocation gl1;
    gl1.chr = "chr1";
    gl1.start = 10000;
    ...
    std::vector<GenomicLocation> originalRegionsBaseBG;

    originalRegionsBaseBG.push_back(gl1);
    originalRegionsBaseBG.push_back(gl2);
    originalRegionsBaseBG.push_back(gl3);
    originalRegionsBaseBG.push_back(gl4);
    originalRegionsBaseBG.push_back(gl5);
    originalRegionsBaseBG.push_back(gl6);
    ...
    {
        std::pair<CharString, char> currentKey = std::make_pair(originalRegionsBaseBG[i].chr, originalRegionsBaseBG[i].strand);
    ...
    EXPECT_TRUE(mapCompare(overlapRegionsBG, controlRegionsBG));
}
